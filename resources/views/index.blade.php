	...
	<body>
					...
					<div class="col-md-10 col-md-offset-2">
						<nav>
							...
							<ul class="clearfix">
								...
								<li class="dot">.</li>
								<li><a href="#work" class="r_spacer">Доставка</a></li>
		...
		<div class="container-fluid intro" id="about">
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					<h1 class="chain">Красивый текст о вас</h1>
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-4 section-text nopadding">
					<div class="wp4">
						<h2 class="frame">Ваши преимущества</h2>
			...
			<div class="row">
				<div class="col-md-4 section-text nopadding">
					<div class="wp5">
						<h2 class="mech">Еще что нибудь о вас</h2>
						<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived.</p>
						<div class="thin-sep"></div>
					</div>
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-4 section-text nopadding">
					<div class="wp6">
						<h2 class="front-frame">Что нибудь еще</h2>
						<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived.</p>
						<div class="thin-sep"></div>
					</div>
						...
						<div class="flexslider">
							<ul class="slides">
								<li>
									...
									<a href="#">Отзыв</a> <span>/ номер 1</span>
									</h2>
								...
								<li>
									<div class="flex-twitter-icon"></div>
									<h2 class="twitter-post-username">
									<a href="#">Отзыв</a> <span>/ номер 2</span>
									</h2>
								...
								<li>
									<div class="flex-twitter-icon"></div>
									<h2 class="twitter-post-username">
									<a href="#">Отзыв</a> <span>/ номер 3</span>
									</h2>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-4 col-md-offset-4">
						<a href="#" class="shop-btn">Изучить магазин</a>
					</div>
				</div>
			</div>
		</section>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3 sign-up">
						<h2 class="logo-header">Подписывайтесь на наши рассылки!</h2>
						<form name="signup-form">
							<input class="signup-input" type="email" name="email_address" value="" placeholder="введите свой email..." title="Please enter a valid email address." required>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-4 footer-leftcol">
						<p><span class="bold-16p">Ваш адрес</span><br>
						номер дома<br>
						город<a href="#"> почта</a>
						</p>
					</div>
